    ...
    const onMutate = (e) => {
      ...
      if(!e.target.files){
        setFormData((x)=>({
            ...
            // if the value on the left is null then use the right's one
        }))
      }
    }
    return (
                ...
                <div className='formButtons'>
                    ...
                    <div className="formRooms flex">
                        <div>
                            ...
                            <input className='formInputSmall' type="number"  id='bedrooms' value={bedrooms} onChange={onMutate} minLength='1' maxLength='50' required/>
                        </div>

                        <div>
                            <label className='formLabel'> Bathrooms</label>
                            <input className='formInputSmall' type="number"  id='bathrooms' value={bathrooms} onChange={onMutate} minLength='1' maxLength='50' required/>
                        </div>
                    </div>
                    ...
                    <textarea className='formInputAddress' type='text' id='address' value={address} onChange={onMutate}/>
                    ...
                    {!geolocationEnabled && (
                        ...
                        <div className='formPriceDiv'>
                            <input className='formInputSmall'  type='number' id='regularPrice' value={regularPrice} onChange={onMutate} minLength='50' maxLength='750000000' required/>
                        ...
                        {offer &&(
                            ...
                            <input className='formInputSmall' type="number" id='discountedPrice' value={discountedPrice} onChange={onMutate} minLength='50' maxLength='750000000' required />
                            </>
                        )}
